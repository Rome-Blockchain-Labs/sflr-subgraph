...
export class AccrueRewards__Params {
  ...
  get userRewardAmount(): BigInt {
    return this._event.parameters[0].value.toBigInt();
  }

  get protocolRewardAmount(): BigInt {
...
export class ProtocolRewardShareRecipientUpdated extends ethereum.Event {
  get params(): ProtocolRewardShareRecipientUpdated__Params {
    return new ProtocolRewardShareRecipientUpdated__Params(this);
  }
}

export class ProtocolRewardShareRecipientUpdated__Params {
  _event: ProtocolRewardShareRecipientUpdated;

  constructor(event: ProtocolRewardShareRecipientUpdated) {
    this._event = event;
  }

  get oldProtocolRewardShareRecipient(): Address {
    return this._event.parameters[0].value.toAddress();
  }

  get newProtocolRewardShareRecipient(): Address {
    return this._event.parameters[1].value.toAddress();
  }
}

export class ProtocolRewardShareUpdated extends ethereum.Event {
  get params(): ProtocolRewardShareUpdated__Params {
    return new ProtocolRewardShareUpdated__Params(this);
  }
}

export class ProtocolRewardShareUpdated__Params {
  _event: ProtocolRewardShareUpdated;

  constructor(event: ProtocolRewardShareUpdated) {
    this._event = event;
  }

  get oldProtocolRewardShare(): BigInt {
    return this._event.parameters[0].value.toBigInt();
  }

  get newProtocolRewardShare(): BigInt {
    return this._event.parameters[1].value.toBigInt();
  }
}
...
export class TotalPooledFlrCapUpdated extends ethereum.Event {
  get params(): TotalPooledFlrCapUpdated__Params {
    return new TotalPooledFlrCapUpdated__Params(this);
  }
}

export class TotalPooledFlrCapUpdated__Params {
  _event: TotalPooledFlrCapUpdated;

  constructor(event: TotalPooledFlrCapUpdated) {
    this._event = event;
  }

  get oldTotalPooldFlrCap(): BigInt {
    return this._event.parameters[0].value.toBigInt();
  }

  get newTotalPooledFlrCap(): BigInt {
    return this._event.parameters[1].value.toBigInt();
  }
}
...
export class SFLR__getPaginatedUnlockRequestsResultValue0Struct extends ethereum.Tuple {
...
export class SFLR__getPaginatedUnlockRequestsResult {
  value0: Array<SFLR__getPaginatedUnlockRequestsResultValue0Struct>;
  value1: Array<BigInt>;
  ...
  getValue0(): Array<SFLR__getPaginatedUnlockRequestsResultValue0Struct> {
    return this.value0;
  }
...
export class SFLR__userUnlockRequestsResult {
  value0: BigInt;
  value1: BigInt;
...
export class SFLR extends ethereum.SmartContract {
  static bind(address: Address): SFLR {
    return new SFLR("SFLR", address);
  }
  ...
  ROLE_SET_TOTAL_POOLED_FLR_CAP(): Bytes {
    let result = super.call(
      "ROLE_SET_TOTAL_POOLED_FLR_CAP",
      "ROLE_SET_TOTAL_POOLED_FLR_CAP():(bytes32)",
      [],
    );
  ...
  try_ROLE_SET_TOTAL_POOLED_FLR_CAP(): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "ROLE_SET_TOTAL_POOLED_FLR_CAP",
      "ROLE_SET_TOTAL_POOLED_FLR_CAP():(bytes32)",
      [],
  ...
  getPaginatedUnlockRequests(
    ...
    from: BigInt,
    to: BigInt,
  ): SFLR__getPaginatedUnlockRequestsResult {
    let result = super.call(
      "getPaginatedUnlockRequests",
    ...
    return new SFLR__getPaginatedUnlockRequestsResult(
      result[0].toTupleArray<SFLR__getPaginatedUnlockRequestsResultValue0Struct>(),
  ...
  try_getPaginatedUnlockRequests(
    ...
    from: BigInt,
    to: BigInt,
  ): ethereum.CallResult<SFLR__getPaginatedUnlockRequestsResult> {
    let result = super.tryCall(
      "getPaginatedUnlockRequests",
      "getPaginatedUnlockRequests(address,uint256,uint256):((uint256,uint256)[],uint256[])",
      [
    ...
    return ethereum.CallResult.fromValue(
      new SFLR__getPaginatedUnlockRequestsResult(
        value[0].toTupleArray<SFLR__getPaginatedUnlockRequestsResultValue0Struct>(),
        value[1].toBigIntArray(),
      ),
    );
  }

  getPooledFlrByShares(shareAmount: BigInt): BigInt {
    let result = super.call(
      "getPooledFlrByShares",
      "getPooledFlrByShares(uint256):(uint256)",
  ...
  try_getPooledFlrByShares(shareAmount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getPooledFlrByShares",
      "getPooledFlrByShares(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(shareAmount)],
  ...
  getSharesByPooledFlr(flrAmount: BigInt): BigInt {
    let result = super.call(
      "getSharesByPooledFlr",
      "getSharesByPooledFlr(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(flrAmount)],
    );

    return result[0].toBigInt();
  }

  try_getSharesByPooledFlr(flrAmount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getSharesByPooledFlr",
      "getSharesByPooledFlr(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(flrAmount)],
  ...
  try_protocolRewardShare(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "protocolRewardShare",
      "protocolRewardShare():(uint256)",
      [],
  ...
  protocolRewardShareRecipient(): Address {
    let result = super.call(
  ...
  try_protocolRewardShareRecipient(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "protocolRewardShareRecipient",
      "protocolRewardShareRecipient():(address)",
      [],
  ...
  submitWrapped(amount: BigInt): BigInt {
    let result = super.call(
      "submitWrapped",
      "submitWrapped(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(amount)],
    );
  ...
  try_submitWrapped(amount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "submitWrapped",
      "submitWrapped(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(amount)],
  ...
  totalPooledFlr(): BigInt {
    let result = super.call("totalPooledFlr", "totalPooledFlr():(uint256)", []);

    return result[0].toBigInt();
  }

  try_totalPooledFlr(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalPooledFlr",
      "totalPooledFlr():(uint256)",
      [],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  try_totalPooledFlrCap(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalPooledFlrCap",
      "totalPooledFlrCap():(uint256)",
      [],
  ...
  userUnlockRequests(
    param0: Address,
    param1: BigInt,
  ): SFLR__userUnlockRequestsResult {
    let result = super.call(
      "userUnlockRequests",
    ...
    return new SFLR__userUnlockRequestsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_userUnlockRequests(
    param0: Address,
    param1: BigInt,
  ): ethereum.CallResult<SFLR__userUnlockRequestsResult> {
    let result = super.tryCall(
      "userUnlockRequests",
      "userUnlockRequests(address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SFLR__userUnlockRequestsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  wrappedToken(): Address {
    let result = super.call("wrappedToken", "wrappedToken():(address)", []);

    return result[0].toAddress();
  }

  try_wrappedToken(): ethereum.CallResult<Address> {
    let result = super.tryCall("wrappedToken", "wrappedToken():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class SetProtocolRewardDataCall extends ethereum.Call {
  get inputs(): SetProtocolRewardDataCall__Inputs {
    return new SetProtocolRewardDataCall__Inputs(this);
  }

  get outputs(): SetProtocolRewardDataCall__Outputs {
    return new SetProtocolRewardDataCall__Outputs(this);
  }
}

export class SetProtocolRewardDataCall__Inputs {
  _call: SetProtocolRewardDataCall;

  constructor(call: SetProtocolRewardDataCall) {
    this._call = call;
  }
...
export class SetProtocolRewardDataCall__Outputs {
  _call: SetProtocolRewardDataCall;
...
export class SetTotalPooledFlrCapCall extends ethereum.Call {
  get inputs(): SetTotalPooledFlrCapCall__Inputs {
    return new SetTotalPooledFlrCapCall__Inputs(this);
  }

  get outputs(): SetTotalPooledFlrCapCall__Outputs {
    return new SetTotalPooledFlrCapCall__Outputs(this);
  }
}

export class SetTotalPooledFlrCapCall__Inputs {
  _call: SetTotalPooledFlrCapCall;

  constructor(call: SetTotalPooledFlrCapCall) {
    this._call = call;
  }
...
export class SetTotalPooledFlrCapCall__Outputs {
  _call: SetTotalPooledFlrCapCall;
...
export class ShareFlareDropCall extends ethereum.Call {
  get inputs(): ShareFlareDropCall__Inputs {
    return new ShareFlareDropCall__Inputs(this);
  }

  get outputs(): ShareFlareDropCall__Outputs {
    return new ShareFlareDropCall__Outputs(this);
  }
}

export class ShareFlareDropCall__Inputs {
  _call: ShareFlareDropCall;

  constructor(call: ShareFlareDropCall) {
    this._call = call;
  }

  get valuedrop(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get infoProtocolReward(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }
}

export class ShareFlareDropCall__Outputs {
  _call: ShareFlareDropCall;
...
export class SubmitWrappedCall extends ethereum.Call {
  get inputs(): SubmitWrappedCall__Inputs {
    return new SubmitWrappedCall__Inputs(this);
  }

  get outputs(): SubmitWrappedCall__Outputs {
    return new SubmitWrappedCall__Outputs(this);
  }
}

export class SubmitWrappedCall__Inputs {
  _call: SubmitWrappedCall;

  constructor(call: SubmitWrappedCall) {
    this._call = call;
  }
...
export class SubmitWrappedCall__Outputs {
  _call: SubmitWrappedCall;
